...
AUTOCOMPLETE_STATUS_FILTER = getattr(
    settings,
    "OSCAR_ELASTICSEARCH_AUTOCOMPLETE_STATUS_FILTER",
...
PRODUCTS_WITH_IMAGES_FIRST = getattr(
    settings, "OSCAR_ELASTICSEARCH_PRODUCTS_WITH_IMAGES_FIRST", False
)

ONLY_PRODUCTS_WITH_IMAGES = getattr(
    settings, "OSCAR_ELASTICSEARCH_ONLY_PRODUCTS_WITH_IMAGES", False
)
